      ...
      <div className="container flex justify-between">
        <div>
          <div className="head ">
            ...
            <span className="group dark:text-gray-700 flex w-fit text-white font-extrabold text-4xl sm:text-4xl sm:my-6 md:gap-x-6 md:text-5xl xl:text-6xl 2xl:my-10 2xl:text-7xl">
          ...
          <div className='flex flex-col'>
            ...
            <div className="flex w-full flex-col items-center gap-y-4 sm:hidden pt-10">
              <a className="w-fit rounded bg-white/20 dark:text-gray-700 dark:hover:text-pink-600 text-white hover:text-pink-400 px-2 py-1 tracking-wider backdrop-blur transition-all dark:bg-neutral-950/20" href="mailto:karanchandravanshi217@gmail.com">karanchandravanshi217@gmail.com</a>
