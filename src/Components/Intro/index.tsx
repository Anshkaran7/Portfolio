...
const Intro = () => {
  return (
    <section id="Intro" className="w-full min-h-[90vh] flex flex-col justify-center">
      <div className="container pl-5 md:pl-28 flex justify-between">
        <div>
        <div className="head ">
          <p className="greeting text-white text-2xl  md:text-5xl font-semibold transition duration-200">
            Hi, my name is
          </p>
          <p className="name text-white text-4xl md:text-7xl font-extrabold transition cursor-pointer duration-200">
            <span className='text-pink-600 transition duration-300 hover:translate-x-6'>&lt; </span>
            Karan Kumar
            <span className='text-pink-600 transition duration-300 hover:translate-x-6'> /&gt;</span>
          </p>
        ...
        <div className='flex flex-col'>
          ...
          <div className="bottom mt-16 ">
            <a href="#Contact">
              <button className=" mr-4 contact text-pink-600 border border-pink-600 duration-500 text-main hover:bg-pink-600 hover:text-white px-6 py-2 rounded-md" aria-label="contact-btn">
                Get in touch
              </button>
            </a>
            <a href="#Work">
          ...
          <div className="flex w-full flex-col items-center gap-y-4 sm:hidden pt-10">
            <a className="w-fit rounded bg-white/20 text-white px-2 py-1 tracking-wider backdrop-blur transition-all dark:bg-neutral-950/20" href="mailto:karanchandravanshi217@gmail.com">karanchandravanshi217@gmail.com</a>
            <div className="flex items-center text-white justify-center gap-x-4 before:block before:h-[1px] before:w-4 before:bg-white after:block after:h-[1px] after:w-4 after:bg-white">
              or
            </div>
            <div className="flex w-[100%] items-center justify-between gap-x-4 mr-4 text-xl">
              <a aria-label="social-link" className="socials text-white cursor-pointer rounded bg-white/20 p-2 backdrop-blur transition dark:bg-neutral-950/20" href="https://www.github.com/Anshkaran7" target="_blank" rel="noopener noreferrer">
              ...
              <a aria-label="social-link" className="socials text-white cursor-pointer rounded bg-white/20 p-2 backdrop-blur transition dark:bg-neutral-950/20" href="https://www.instagram.com/Anshkaran7" target="_blank" rel="noopener noreferrer">
              ...
              <a aria-label="social-link" className="socials text-white cursor-pointer rounded bg-white/20 p-2 backdrop-blur transition dark:bg-neutral-950/20" href="https://www.twitter.com/itsmeekaran" target="_blank" rel="noopener noreferrer">
              ...
              <a aria-label="social-link" className="socials text-white cursor-pointer rounded bg-white/20 p-2 backdrop-blur transition dark:bg-neutral-950/20" href="https://www.linkedin.com/in/karan-kumar-416321239/" target="_blank" rel="noopener noreferrer">
        ...
        {/* <div className='md:flex hidden'>
          <Image src={"/assets/boy.png"} width={400} height={400} alt='boy'/>
        </div> */}
