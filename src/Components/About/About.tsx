            ...
            <div className="fade-in flex w-full flex-col items-center  justify-between lg:flex-row lg:items-start lg:gap-x-8 text-white">
                <div className='flex flex-col  gap-y-6 items-center'>
                    ...
                    <div className="mt-12 dark:text-gray-800 ">
                        ...
                        <p className="lg:w-[80%] ">
                            Hi, I'm Karan Kumar, a Full Stack Developer from India. I'm a student pursuing my B.Tech in Computer Science from Parul University. I specialize in frontend development and have been in the field for 6-7 months.                        <br />
                            <br />
